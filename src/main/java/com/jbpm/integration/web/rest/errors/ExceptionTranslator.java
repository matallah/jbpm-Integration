...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.jbpm.integration.service.EmailAlreadyUsedException ||
            ex instanceof com.jbpm.integration.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.jbpm.integration.service.InvalidPasswordException
